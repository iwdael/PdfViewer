package com.iwdael.pdfviewer.scroll;
...
public class DefaultScrollHandle extends RelativeLayout implements ScrollHandle {
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        LayoutParams lp = new LayoutParams(Utils.getDP(context, width), Utils.getDP(context, height));
    ...
    private void setPosition(float pos) {
        ...
        if (pos < 0) {
            pos = 0;
        } else if (pos > pdfViewSize - Utils.getDP(context, HANDLE_SHORT)) {
            pos = pdfViewSize - Utils.getDP(context, HANDLE_SHORT);
        }
