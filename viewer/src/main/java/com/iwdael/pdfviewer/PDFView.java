...
import com.iwdael.pdfviewer.util.Utils;
...
import com.iwdael.pdfviewer.exception.PageRenderingException;
import com.iwdael.pdfviewer.link.DefaultLinkHandler;
import com.iwdael.pdfviewer.link.LinkHandler;
import com.iwdael.pdfviewer.listener.Callbacks;
import com.iwdael.pdfviewer.listener.OnDrawListener;
import com.iwdael.pdfviewer.listener.OnErrorListener;
import com.iwdael.pdfviewer.listener.OnLoadCompleteListener;
import com.iwdael.pdfviewer.listener.OnLongPressListener;
import com.iwdael.pdfviewer.listener.OnPageChangeListener;
import com.iwdael.pdfviewer.listener.OnPageErrorListener;
import com.iwdael.pdfviewer.listener.OnPageScrollListener;
import com.iwdael.pdfviewer.listener.OnRenderListener;
import com.iwdael.pdfviewer.listener.OnTapListener;
import com.iwdael.pdfviewer.model.PagePart;
import com.iwdael.pdfviewer.scroll.ScrollHandle;
import com.iwdael.pdfviewer.util.Constants;
import com.iwdael.pdfviewer.util.FitPolicy;
import com.iwdael.pdfviewer.util.MathUtils;
import com.iwdael.pdfviewer.util.SnapEdge;
import com.iwdael.pdfviewer.core.model.Size;
import com.iwdael.pdfviewer.core.model.SizeF;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

import static com.iwdael.pdfviewer.util.Constants.PRELOAD_OFFSET;
...
public class PDFView extends RelativeLayout {
     ...
     * and taking into account the zoom level, the current offset is the position of the left border of the screen in this big picture
     */
...
//    private CoreSource pdfiumCore;
    ...
    private void setSpacing(int spacingDp) {
        this.spacingPx = Utils.getDP(getContext(), spacingDp);
    }
     ...
     */
    public Configurator fromSource(DocumentSource source) {
