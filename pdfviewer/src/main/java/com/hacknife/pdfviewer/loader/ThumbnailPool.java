...
public class ThumbnailPool {
    ...
    public void launch() {
        this.executor = new ThreadPoolExecutor(CORE_POOL_SIZE, MAX_POOL_SIZE, KEEP_ALIVE_TIME, KEEP_ALIVE_TIME_UNIT, new PriorityBlockingLimitQueue<Runnable>(configurator.thumbnailPatchCount()), new RejectedHandler(configurator.thumbnailPatchCount()));
    }
